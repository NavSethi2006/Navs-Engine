 ...
 */
  ...
  */
 typedef struct NE_Animation {
    NE_Frame *frames;       /**< Array of frames. */
  ...
  */
 typedef struct NE_Animation_set {
     NE_Texture *texture;    /**< The texture shared across animations. */
     int animation_count; /** < The count of animations. */
     NE_Animation *animations[]; /**< Array of animations for different states. */
 } NE_Animation_set;
